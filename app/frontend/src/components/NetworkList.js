...
const NetworkList = () => {
    ...
    const handleCreateNetwork = async (config) => {
        try {
            await api.createNetwork(config);
            refresh();
        ...
        <div>
            <div className="flex justify-between items-center mb-4">
                ...
                <div>
                    ...
                    <Button variant="contained" onClick={refresh} disabled={loading.networks} startIcon={<Refresh />} className="ml-4">
                        Refresh
                    </Button>
                </div>
            </div>
