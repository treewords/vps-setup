...
export const buildImage = (dockerfileContent, tags) => {
    return apiClient.post('/images/build', { dockerfileContent, tags });
};
...
export const connectNetwork = (id, containerId) => {
    return apiClient.post(`/networks/${id}/connect`, { containerId });
};

export const disconnectNetwork = (id, containerId) => {
